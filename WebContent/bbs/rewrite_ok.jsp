...
<%
	...
	String imgpath="";
	if(mr.getFilesystemName("bbs_imgpath")==null||mr.getFilesystemName("bbs_imgpath").equals("")){
		imgpath = mr.getParameter("imgpath");
	}else{
		imgpath = mr.getFilesystemName("bbs_imgpath");
	}
	
	String content=mr.getParameter("bbs_content");	
	int idx =Integer.parseInt(mr.getParameter("bbs_idx"));
	int result=bdao.bbsReWrite(subject, imgpath, content, idx);
