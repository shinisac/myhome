...
<body>
	...
	<header>
		<div id="mainheader">
			...
			<div id="mainmenu">
				<img alt="마이홈 이미지로고" src="/myhome/img/mainhomeR.jpg" width="200"height="70">
			</div>
		</div>
	</header>
	
			<form name="login" action="admin_login_ok.jsp" class="signUp" id="signupForm" method="POST">
   		<h1 class="signUpTitle">Admin Login</h1>
         <input type="text" class="signUpInput" name="admin_id" placeholder="아이디"1 autofocus required>
         <input type="password" class="signUpInput" name="admin_pwd" placeholder="비밀번호" required>
