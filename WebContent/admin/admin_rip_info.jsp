...
ArrayList<ripDTO> arr=admindao.membrerRipList(idx, member_id);
%>
...
<table	align="center" id="main">
			...
			<tfoot>
				...
				%>	<tr>
						...
						<td colspan="2"><%=arr.get(i).getRip_content()%></td>
						<td><%=arr.get(i).getRip_bbs_writedate() %></td>
					</tr>
						<% 
							}			
				%>
				<tr>
					<td colspan="4" align="center" style="border-bottom: 0px solid #ddd">
