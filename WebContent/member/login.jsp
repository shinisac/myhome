...
<form name="myhomelogin" action="login_ok.jsp" class="signUp" id="signupForm" method="POST">
   <h1 class="signUpTitle">Login</h1>
         <input type="text" class="signUpInput" name="userid" placeholder="아이디" value="<%=saveid %>" autofocus required>
         <input type="password" class="signUpInput" name="userpwd" placeholder="비밀번호" required>
         <div class="form-group"><label class="form-remember"><input type="checkbox" name="saveid" value="on"   
         <%=saveid.equals("")?"":"checked" %>>
         ID 기억하기</label></div><br>
         <input type="submit" value="Login" class="signUpButton" id="signupForm"><br><br>
         <a href="/myhome/member/IDfind.jsp"><input type="button" value="아이디,비밀번호 찾기" id="signupForm" class="signUpButton"></a>
</form>
